        ...
        builder: (context, state) {
          ...
          if (state is AuthAuthenticated) {
            ...
            if (state.appUser == null) {
              // Fetch user data from Firestore if appUser is null
              return FutureBuilder<AppUser?>(
                ...
                builder: (context, snapshot) {
                  ...
                  // Initialize controllers after fetching appUser
            ...
            // Initialize controllers for non-null appUser
            if (_firstNameController.text.isEmpty) {
              _firstNameController.text = appUser.firstName;
              _lastNameController.text = appUser.lastName;
              _emailController.text = appUser.email ?? user.email ?? '';
                      ...
                      children: [
                        ...
                        _buildProfileInfoItem(
                          ...
                          subtitle: user.email != null && user.email!.isNotEmpty
                              ...
                              : null,
                          subtitleColor: user.email != null && user.email!.isNotEmpty
                              ? (user.emailVerified ? Colors.green : Colors.amber)
                              : null,
                        ),
                        _buildProfileInfoItem(
